/* *************************************************************************** #
#                                                                              #
#       _______                ex02/test_ft_print_reverse_alphabet.c           #
#      |.-----.|                                                               #
#      ||x . x||                 By: fdi-tria <fdi-tria@student.42lausanne.ch> #
#      ||_.-._||                                                               #
#       -------                  Created: 19/06/2024 10:00:00                  #
#     __[=== o]___                                                             #
#    |:::::::::::|\              Updated: 19/06/2024 10:00:00                  #
#     -=========-                                                              #
# ***************************************************************************  #
ChangeLog:
v0.0.1: fdi-tria, 19/06/2024 10:00:00
    - Initial release
# *************************************************************************** */
...
int main() {
    ...
    fprintf(expected, "zyxwvutsrqponmlkjihgfedcba\n");
    fclose(expected);
    ...
    if (compare_files("output.txt", "expected_output.txt")) {
        ...
        printf("Test échoué. La sortie attendue est 'zyxwvutsrqponmlkjihgfedcba\\n'.\n");
    }
...
main:
- Ce script de test vérifie la fonction ft_print_reverse_alphabet en affichant l'alphabet en minuscule dans l'ordre décroissant.
...
1. Compiler uniquement ft_print_reverse_alphabet.c:
gcc -Wall -Wextra -Werror -c ft_print_reverse_alphabet.c -o ft_print_reverse_alphabet.o

2. Compiler ft_print_reverse_alphabet.c et générer un exécutable pour les tests:
gcc -Wall -Wextra -Werror -o test/test_ft_print_reverse_alphabet ft_print_reverse_alphabet.c test/test_ft_print_reverse_alphabet.c
...
Contexte:
- Ce fichier est un script de test pour vérifier le bon fonctionnement de la fonction ft_print_reverse_alphabet.
- L'objectif est de s'assurer que ft_print_reverse_alphabet affiche correctement l'alphabet en minuscule sur une seule ligne, dans l'ordre décroissant.

Notes:
- Ce script est optionnel et est utilisé pour vérifier la fonction localement avant la soumission.
- Assurez-vous de compiler et d'exécuter ce script pour valider le comportement de ft_print_reverse_alphabet.
