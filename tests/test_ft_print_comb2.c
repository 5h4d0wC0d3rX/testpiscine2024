/* *************************************************************************** #
#                                                                              #
#       _______                ex06/test_ft_print_comb2.c                      #
#      |.-----.|                                                               #
#      ||x . x||                 By: fdi-tria <fdi-tria@student.42lausanne.ch> #
#      ||_.-._||                                                               #
#       -------                  Created: 19/06/2024 12:10:00                  #
#     __[=== o]___                                                             #
#    |:::::::::::|\              Updated: 19/06/2024 12:10:00                  #
#     -=========-                                                              #
# ***************************************************************************  #
ChangeLog:
v0.0.1: fdi-tria, 19/06/2024 12:10:00
    - Initial release
# *************************************************************************** */
...
int main() {
    ...
    if (compare_files("output.txt", "expected_output.txt")) {
        ...
        printf("Test échoué. La sortie attendue est '00 01, 00 02, ..., 98 99\\n'.\n");
    }
...
main:
- Ce script de test vérifie la fonction ft_print_comb2 en affichant toutes les combinaisons de deux nombres entre 00 et 99.
...
1. Compiler uniquement ft_print_comb2.c:
gcc -Wall -Wextra -Werror -c ft_print_comb2.c -o ft_print_comb2.o

2. Compiler ft_print_comb2.c et générer un exécutable pour les tests:
gcc -Wall -Wextra -Werror -o test/test_ft_print_comb2 ft_print_comb2.c test/test_ft_print_comb2.c
...
Contexte:
- Ce fichier est un script de test pour vérifier le bon fonctionnement de la fonction ft_print_comb2.
- L'objectif est de s'assurer que ft_print_comb2 affiche correctement toutes les combinaisons de deux nombres entre 00 et 99.

Notes:
- Ce script est optionnel et est utilisé pour vérifier la fonction localement avant la soumission.
- Assurez-vous de compiler et d'exécuter ce script pour valider le comportement de ft_print_comb2.
