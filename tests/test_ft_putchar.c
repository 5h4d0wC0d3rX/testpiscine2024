/* *************************************************************************** #
#                                                                              #
#       _______                ex00/test_ft_putchar.c                          #
#      |.-----.|                                                               #
#      ||x . x||                 By: fdi-tria <fdi-tria@student.42lausanne.ch> #
#      ||_.-._||                                                               #
#       -------                  Created: 18/06/2024 19:35:00                  #
#     __[=== o]___                                                             #
#    |:::::::::::|\              Updated: 19/06/2024 09:30:00                  #
#     -=========-                                                              #
# ***************************************************************************  #
ChangeLog:
v0.0.1: fdi-tria, 18/06/2024 19:35:00
    - Initial release
...
int main() {
    ...
    // Test 1: Afficher un seul caractère
    ft_putchar('A');
    ...
    if (compare_files("output.txt", "expected_output.txt")) {
        ...
        printf("Test échoué. La sortie attendue est 'A\\n'.\n");
    }
...
main:
- Ce script de test vérifie la fonction ft_putchar en affichant les caractères 'A'.
...
1. Compiler uniquement ft_putchar.c:
gcc -Wall -Wextra -Werror -c ft_putchar.c -o ft_putchar.o

2. Compiler ft_putchar.c avec le fichier de test situé dans le répertoire test:
gcc -Wall -Wextra -Werror -o test/test_ft_putchar test/test_ft_putchar.c ft_putchar.c
...
Contexte:
- Ce fichier est un script de test pour vérifier le bon fonctionnement de la fonction ft_putchar.
- L'objectif est de s'assurer que ft_putchar affiche correctement les caractères passés en argument.

Notes:
- Ce script est optionnel et est utilisé pour vérifier la fonction localement avant la soumission.
- Assurez-vous de compiler et d'exécuter ce script pour valider le comportement de ft_putchar.
