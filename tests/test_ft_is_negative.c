/* *************************************************************************** #
#                                                                              #
#       _______                ex04/test_ft_is_negative.c                      #
#      |.-----.|                                                               #
#      ||x . x||                 By: fdi-tria <fdi-tria@student.42lausanne.ch> #
#      ||_.-._||                                                               #
#       -------                  Created: 19/06/2024 10:50:00                  #
#     __[=== o]___                                                             #
#    |:::::::::::|\              Updated: 19/06/2024 10:50:00                  #
#     -=========-                                                              #
# ***************************************************************************  #
ChangeLog:
v0.0.1: fdi-tria, 19/06/2024 10:50:00
    - Initial release
# *************************************************************************** */
...
int main() {
    ...
    if (compare_files("output.txt", "expected_output.txt")) {
        ...
        printf("Test échoué. La sortie attendue est 'N\\nP\\nP\\n'.\n");
    }
...
main:
- Ce script de test vérifie la fonction ft_is_negative avec plusieurs cas de test.
...
1. Compiler uniquement ft_is_negative.c:
gcc -Wall -Wextra -Werror -c ft_is_negative.c -o ft_is_negative.o

2. Compiler ft_is_negative.c et générer un exécutable pour les tests:
gcc -Wall -Wextra -Werror -o test/test_ft_is_negative ft_is_negative.c test/test_ft_is_negative.c
...
Contexte:
- Ce fichier est un script de test pour vérifier le bon fonctionnement de la fonction ft_is_negative.
- L'objectif est de s'assurer que ft_is_negative affiche correctement 'N' ou 'P' suivant le signe de l'entier passé en paramètre.

Notes:
- Ce script est optionnel et est utilisé pour vérifier la fonction localement avant la soumission.
- Assurez-vous de compiler et d'exécuter ce script pour valider le comportement de ft_is_negative.
